...
move "C:\Applications\Steam\steamapps\common\Battle Brothers\data\%modname%*.zip" "%~dp0\old_versions\%modname%-%ymddate%-%hmstime%.zip"

echo.
echo Installing new version, if any, to data directory...
echo.

move "%~dp0\dist\%modname%*.zip" "C:\Applications\Steam\steamapps\common\Battle Brothers\data\" 2> nul
